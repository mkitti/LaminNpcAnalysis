...
function [pStruct,rejected] = fitGaussianMixtures2D(img, x, y, A, sigma, c, varargin)
...
% record which initial local maxima were rejected
if(nargout > 1)
    rejected = cellfun('isempty',pStruct.x);
end
